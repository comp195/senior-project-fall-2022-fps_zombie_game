...
after a number of kills. After those are finish, we only need to add the lose condition and then the 
base game is done. We are just left with zombie attack logic and to make the game winnable and looseable.